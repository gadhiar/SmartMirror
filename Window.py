...
'''
Set these two to the path of your own credentials and client_secret files
'''
        ...
        try:
            if latitude is None and longitude is None:
                ...
                try:
                    ...
                    lon = '-74.029068'
                    traceback.print_exc()
                    print('Error: %s. Could not get coordinates. Using defaults: (Hoboken, NJ)') % e
                # get the weather
...
class CalendarDate(Frame):
    ...
    def updateDate(self, events):
        ...
        try:
            ...
            traceback.print_exc()
            print("Error: %s. Cannot animate weather labels." % e)
